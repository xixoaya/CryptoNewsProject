 ...
 */
function addFavToBulletin(token, bulletinId) {
    ...
    return (async () => {
        ...
        let { clicksFav = 0 } = await res.json()

        const newClicksFav = {
            clicksFav: clicksFav + 1,
            id: bulletinId
        }
        ...
        const res2 = await fetch(`http://localhost:8000/api/bulletins`, {
            ...
            body: JSON.stringify( newClicksFav )
        })
...
export default addFavToBulletin